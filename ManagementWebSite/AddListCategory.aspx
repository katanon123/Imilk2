<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="AddListCategory.aspx.cs" Inherits="AddCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="TITLE_BREADCRUMBContentPlaceHolder" runat="Server">
    <ul class="page-breadcrumb breadcrumb">
        <li>
            <i class="fa fa-home"></i><a href="AddListCategory.aspx?Type=<%= Request.QueryString["Type"] %>"><asp:Literal runat="server" ID="title2"></asp:Literal></a>
        </li>
    </ul>
</asp:Content>
        ...
        <div class="col-lg-12">
            <div class="portlet box yellow">
                <div class="portlet-title">
                    <div class="caption">
                        <asp:Literal runat="server" ID="title3"></asp:Literal>
                    </div>
                    <div class="actions">
                        <div class="btn-group">
    ...
    <asp:Panel ID="AddPanel" runat="server" Visible="false">
        <div class="col-lg-12">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        เพิ่มอาหารเเละเครื่องดื่มประเภท<asp:Label ID="titleadd" runat="server"></asp:Label>
                    </div>
                </div>
            ...
            <div class="portlet box yellow">
                ...
                <div class="portlet-body form">
                    <div class="form-body">
                        ...
                        <asp:RadioButtonList ID="RadioButtonList" runat="server" Font-Size="X-Large"></asp:RadioButtonList>
                    </div>
                        <div class="form-group;" style="text-align: center;">
