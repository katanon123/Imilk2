...
public partial class ListPayment : System.Web.UI.Page
{
    ...
    public void getdata()
    {
        ...
        foreach (CommonClassLibrary.CommonDataSet.PaymentProductOrderDetailUserRow item in collection)
        {
            ...
            total += item.Total;
            dt.Rows.Add(day, "DGS-" + item.TicketOrder, item.Total.ToString("#,###") + ".-", item.FirstName + "  " + item.LastName);
        }
        this.TicketOrderRepeater.DataSource = dt;
        this.TicketOrderRepeater.DataBind();
    }
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        if (Date_TextBox1.Text != "" && Date_TextBox2.Text != "")
        {
            ...
            //DateTime sta = Calendar1.SelectedDate;
