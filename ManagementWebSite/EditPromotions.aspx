<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="EditPromotions.aspx.cs" Inherits="EditBeverage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="TITLE_BREADCRUMBContentPlaceHolder" runat="Server">
    <ul class="page-breadcrumb breadcrumb">
        <li>
            <i class="fa fa-home"></i><asp:HyperLink ID="BackMenu_HyperLink" NavigateUrl="~/Promotion.aspx" runat="server" >โปรโมชั่น</asp:HyperLink>
            <span class="fa fa-angle-double-right"></span>
        </li>
        <li>
            <asp:Label ID="Menu1_Label" runat="server">แก้ไขโปรโมชั่น</asp:Label>
        </li>
    </ul>
</asp:Content>
    ...
    <div class="col-lg-12">
        <div class="portlet box grey">
            <div class="portlet-title">
                <div class="caption">
                    <asp:Label ID="Menu2_Label" runat="server">แก้ไขโปรโมชั่น</asp:Label>
                </div>
            </div>
