<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="MenuBeverage.aspx.cs" Inherits="MenuBeverage" %>
                ...
                <table class="table table-bordered table-hover table-full-width" id="sample_2">
                    <thead>
                        <tr>
                            ...
                            <th><strong>ราคาโปรโมชั่น</strong></th>
                        ...
                        <asp:Repeater ID="BeverageRepeater" runat="server" OnItemDataBound="BeverageRepeater_ItemDataBound">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td style="width:100px"><%# Eval("Name") %><br /><%# Eval("NameEN") %></td>
                                      <td style="width: 70px;">
                                                            <%--<img src='<%#Eval("ImageURL")%>' width="132" class="center-block" />--%>
                                    ...
                                    <td style="width:15%"><%# Eval("PromotionPrice") %></td>
                                    <td style="width:10%">
