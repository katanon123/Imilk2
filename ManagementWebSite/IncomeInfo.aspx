<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="IncomeInfo.aspx.cs" Inherits="IncomeInfo" UICulture="en-US" Culture="en-US" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="TITLE_BREADCRUMBContentPlaceHolder" Runat="Server">
    <ul class="page-breadcrumb breadcrumb">
        <li>
            <i class="fa fa-home"></i><a href="IncomeInfo.aspx">รายได้</a>
        </li>
            ...
            <div class="portlet-body">
                <table class="table table-striped table-bordered table-hover table-full-width" id="sample_4">
                    ...
                    <tbody>
                            ...
                            <ItemTemplate>
                                <tr>
                                   ...
                                   <td style="width: 25px; text-align: center;"><asp:Label ID="No_Label" runat="server" Text='<%# Container.ItemIndex + 1 %>' ></asp:Label></td>
                                     <td><asp:Label ID="Day_Label" runat="server" Text='<%# Eval("Day") %>'  ForeColor="#CC0000"></asp:Label></td>
                                  
                                    <td style="width: 325px"><asp:Label ID="TicketCode_Label" runat="server" Text='<%# Eval("Code") %>'  ForeColor="#333399"></asp:Label></td>
                                    <td style="width: 325px">
                                       <asp:Label ID="Label1" runat="server" Text='<%# Eval("Total") %>'  ForeColor="#333399"></asp:Label>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
                        ...
                        <tr>
                            <td colspan="3" style="text-align: right" class="auto-style1">
