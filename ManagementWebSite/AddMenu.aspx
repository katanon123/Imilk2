<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="AddMenu.aspx.cs" Inherits="AddMenu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="TITLE_BREADCRUMBContentPlaceHolder" runat="Server">
    <ul class="page-breadcrumb breadcrumb">
        <li>
            <i class="fa fa-home"></i><a href="AddMenu.aspx"><asp:Label runat="server" ID="headtitle2"></asp:Label></a>
        </li>
    </ul>
</asp:Content>
    ...
    <div class="col-lg-12">
        <div class="portlet box red">
            <div class="portlet-title">
                <div class="caption">
                   <asp:Label runat="server" ID="headtitle3"></asp:Label>
                </div>
            </div>
            <div class="portlet-body form">
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ForeColor="Red" ControlToValidate="Price_TextBox" Display="Dynamic" ErrorMessage="กรุณากรอกข้อความ"></asp:RequiredFieldValidator>
                        <asp:TextBox ID="Price_TextBox" runat="server" CssClass="form-control" placeholder="0.00" onkeyup="value=value.replace(/[^0-9,'.']/g,'')"></asp:TextBox>
                       
                    </div>

                    <div class="form-group">
                        <p><strong>ราคาพิเศษ :</strong></p>
                        <asp:TextBox ID="PromotionPrice_TextBox" runat="server" CssClass="form-control" placeholder="0.00" onkeyup="value=value.replace(/[^0-9,'.']/g,'')"></asp:TextBox>
                    </div>
